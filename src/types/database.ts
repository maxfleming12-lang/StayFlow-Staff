    ...
    Tables: {
      announcement_acknowledgements: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "announcement_acknowledgements_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
      ...
      calendar_tokens: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "calendar_tokens_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      clock_events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "clock_events_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      document_acknowledgements: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "document_acknowledgements_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      emergency_contacts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "emergency_contacts_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      employment_details: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "employment_details_profile_fk"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      leave_requests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "leave_requests_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "leave_requests_reviewer_profile_fk"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      notifications: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "notifications_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      push_subscriptions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "push_subscriptions_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      shift_acknowledgements: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "shift_acknowledgements_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      shifts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "shifts_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      staff_availability: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "staff_availability_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      task_assignments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "task_assignments_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      task_comments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "task_comments_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      timesheet_adjustment_requests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "timesheet_adjustment_requests_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      timesheets: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "timesheets_profile_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
